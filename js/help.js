...
window.HELP = [
  ...
  },
  {
    ...
    body: {
      bn: [
        '<b>🧾 রসিদ</b> — দাতার পাতায় প্রতিটা জমার পাশে 🧾 চাপো। একটা রসিদের ছবি তৈরি হবে (দাতার নাম, তারিখ, এই কিস্তি, মোট জমা/কথা, বাকি, সংগ্রাহক) — সেটা সরাসরি <b>WhatsApp-এ পাঠাতে পারো</b> বা ফোনে সেভ করতে পারো।',
        '<b>📞 মনে করাও</b> — যে দাতার <b>বাকি আছে আর ফোন নম্বর দেওয়া আছে</b>, তার পাতায় এই বোতাম আসে। চাপলে WhatsApp খুলে যাবে, বার্তা আগে থেকেই লেখা থাকবে (নাম + কত বাকি) — <b>তুমি নিজে পড়ে তারপর send করবে</b>, নিজে থেকে চলে যায় না।',
        'রসিদ তোমার ফোনেই তৈরি হয় — কোনো ছবি সার্ভারে যায় না।',
      ],
      en: [
        '<b>🧾 Receipt</b> — on a donor\'s page, tap 🧾 next to any payment. It creates a receipt image (donor, date, this payment, total paid vs pledged, due, collector) that you can <b>share straight to WhatsApp</b> or save to the phone.',
        '<b>📞 Remind</b> — appears on donors who <b>still owe money and have a phone number</b>. It opens WhatsApp with the message pre-written (name + amount due) — <b>you read it and tap send yourself</b>; nothing is sent automatically.',
        'Receipts are drawn on your own phone — no image is uploaded anywhere.',
      ],
    },
  },
  {
