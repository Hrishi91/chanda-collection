  ...
  },
  {
    ...
    body: {
      bn: [
        ...
        '<b>🤝 সদস্য</b> — সবাই ডিফল্টে <b>সদস্য</b>, তাই পদ আলাদা করে জিজ্ঞেস করে না। Admin যদি <b>🏷️ সদস্যের ধরন</b> (আজীবন / বার্ষিক …) বা একাধিক <b>পদ</b> যোগ করেন, তখন প্রশ্নগুলো নিজে থেকেই আসবে — কিছু আপডেট লাগবে না। সদস্যের চাঁদা নেওয়ার সময় <b>কীসের চাঁদা সেটা লিখতেই হবে</b> — মাসিক, অনুষ্ঠান, বিশেষ দান — কারণ এক সদস্য বছরে বহুবার দেন, শুধু অঙ্ক দেখে পরে আর বোঝা যায় না।',
      ...
      en: [
        ...
        '<b>🤝 Member</b> — everyone is a <b>member</b> by default, so the position is not asked. If the admin adds <b>🏷️ membership types</b> (life / annual …) or more than one <b>position</b>, those questions appear on their own — no update needed. Taking a member\'s contribution <b>requires a comment</b> — monthly, function, special donation — because one member pays many times a season and the amount alone will not say which.',
