...
window.HELP = [
  ...
  },
  {
    ...
    body: {
      bn: [
        'তোমার হাতে টাকা জমে গেলে <b>🤝 জমা দিলাম</b> → কোন cashier। তারপর <b>কোন খাতের টাকা</b> — <b>📥 নতুন এন্ট্রি/চাঁদা</b> আর <b>🛣️ দৈনিক কালেকশন</b> (রোড/টোটো/বাস) আলাদা ভাগে সাজানো, প্রতিটা লাইনে <b>💵 নগদ · 📱 UPI · মোট</b> আর প্রতি ভাগের সাবটোটাল — অর্থাৎ সব হিসাব এই এক স্ক্রিনেই, অন্য পাতায় গিয়ে দেখার দরকার নেই। এক বা একাধিক বাছো, নিচে "বেছেছ" লাইনে নগদ/UPI/মোট সাথে সাথে যোগ হয়। তারপর <b>নগদ / UPI / দুটোই</b> — এখানেও বাছাই-করা খাতগুলোর আসল টাকা লেখা। কোথাও টাইপ করতে হয় না। ভিন্ন (আংশিক) amount দিতে <b>"✏️ অন্য পরিমাণ"</b> চেপে টাইপ করো।',
