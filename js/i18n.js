...
const I18N = {
  ...
  new_password: { bn: 'নতুন পাসওয়ার্ড (কমপক্ষে ৪ অক্ষর)', en: 'New password (min 4 chars)' },
  ...
  err_bad_input: { bn: 'সব ঘর ঠিক করে ভরো (পাসওয়ার্ড কমপক্ষে ৪)', en: 'Fill all fields (password min 4)' },
