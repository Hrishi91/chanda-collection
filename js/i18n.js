...
const I18N = {
  ...
  find_party_hint: { bn: 'অন্য collector-এর তোলা দাতাও এখানে আছে — নাম খুঁজে চাপো, তারপর টাকা জমা দাও (টাকা তোমার হাতে গণ্য হবে)।', en: "Donors added by any collector are here — search a name, tap, then record the payment (counts as cash in your hand)." },
  ...
  q_handover_sheet: { bn: 'কোন খাতের কত টাকা জমা দিচ্ছ?', en: 'How much from each source are you handing over?' },
  sheet_hint: { bn: 'সবটা দিলে কিছু বদলাতে হবে না — কম দিলে ঘরে কম লেখো', en: 'Handing over everything? Change nothing. Giving less? Just edit that box.' },
