...
const I18N = {
  ...
  receipt_send_wa: { bn: 'WhatsApp-এ পাঠাও', en: 'Send on WhatsApp' },
  receipt_wa_hint: { bn: 'দাতার নম্বরেই ({phone}) সরাসরি খুলবে — নম্বর টাইপ করতে হবে না। লেখা রসিদ যাবে; তুমি send চাপবে।', en: 'Opens the donor\'s own chat ({phone}) — no number to type. Sends the text receipt; you tap send.' },
  receipt_no_phone: { bn: 'এই দাতার ফোন নম্বর দেওয়া নেই — তাই সরাসরি পাঠানো যাচ্ছে না।', en: 'This donor has no phone number saved — so there is no direct chat to open.' },
  receipt_add_phone: { bn: 'নম্বর যোগ করো', en: 'Add the number' },
  receipt_img_hint: { bn: 'ছবি পাঠালে WhatsApp নিজেই কাকে পাঠাবে জিজ্ঞেস করবে — ছবি সরাসরি কারো নামে পাঠানোর রাস্তা ফোন দেয় না।', en: 'Sending the image opens the share sheet, where you pick the person — phones give no way to pre-address a picture.' },
  receipt_send_img: { bn: 'ছবির রসিদ পাঠাও', en: 'Send the picture receipt' },
