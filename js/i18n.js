...
const I18N = {
  ...
  // A153: the অনুষ্ঠান tab — everything about the programme in one place.
  nav_program: { bn: 'অনুষ্ঠান', en: 'Programme' },
  perm_progteam: { bn: '🎭 অনুষ্ঠানের দলে', en: '🎭 On the programme team' },
  perm_progteam_hint: { bn: 'এটা দিলে তবেই 🎭 tab দেখা যাবে — নিচের তিনটে এর ভিতরের কাজ',
                        en: 'Grants the 🎭 tab itself — the three below are what they may do inside it' },
  perm_progdonor: { bn: '🎭 অনুষ্ঠানের দাতা লেখা', en: '🎭 Enter programme donors' },
  perm_progmoney: { bn: '🎭 অনুষ্ঠানের টাকা খরচ / দায় / ভাঁড়ার-বদল',
                    en: '🎭 Spend, promise and move the programme fund' },
  program_tab_sub: { bn: 'অনুষ্ঠানের নিজের খাতা', en: "The programme's own book" },
  prog_sec_entry: { bn: '📥 এন্ট্রি', en: '📥 Entry' },
  prog_sec_list: { bn: '📒 খাতা', en: '📒 Ledger' },
  prog_sec_report: { bn: '📊 হিসাব', en: '📊 Account' },
  prog_donor: { bn: 'অনুষ্ঠানের দাতা', en: 'Programme donor' },
  prog_no_grants: { bn: 'এখানে কিছু করার অনুমতি এখনো তোমাকে দেওয়া হয়নি — admin-কে বলো।',
                    en: 'You have not been granted anything here yet — ask the admin.' },
  prog_no_donors: { bn: 'অনুষ্ঠানের খাতায় এখনো কোনো দাতা নেই',
                    en: 'No donors in the programme book yet' },
  prog_list_hint: { bn: 'এটা শুধু অনুষ্ঠানের খাতা — পুজোর দাতারা 📒 খাতা tab-এ।',
                    en: "This is the programme's book only — puja donors are in the 📒 tab." },
  ...
  duty_title: { bn: '🤝 দায় — কথা দেওয়া আছে', en: '🤝 Committed — promised, not yet paid' },
  duty_add: { bn: '➕ নতুন দায় লেখো', en: '➕ Record a commitment' },
  ...
  duty_none: { bn: 'কাউকে কিছু কথা দেওয়া নেই', en: 'Nothing promised to anybody' },
  spoken_for: { bn: 'এর মধ্যে কথা দেওয়া আছে', en: 'Of that, already promised' },
  really_free: { bn: 'সত্যিই খোলা আছে', en: 'Actually free' },
  spoken_for_note: { bn: 'টাকাটা হাতেই আছে — কিন্তু এর মধ্যে এতটা আগেই কথা দেওয়া। খরচের পরিকল্পনা এই বাকিটা ধরেই করো।',
                     en: 'The money is in hand — but this much is already promised. Plan against what is left.' },
  q_duty_against: { bn: 'এটা কোন দায়ের টাকা?', en: 'Against which commitment?' },
  duty_against_none: { bn: 'কোনোটার নয়', en: 'None of them' },
  ...
  restore_confirm: { bn: '⚠️ "{f}" ফেরালে এখনকার সব ডেটা ওই সময়ের অবস্থায় ফিরে যাবে। (নিরাপত্তার জন্য এখনকার অবস্থার backup আগে নেওয়া হবে।)\n\n🔑 সবাই — তুমি সহ — লগ-আউট হয়ে যাবে, আবার login করতে হবে।\n\n📵 আর কারো ফোনে যা তখনো পাঠানো হয়নি, সেগুলো নিজে থেকে যাবে না — মুছে যাবে, আর ওই ফোনে ⚙️ সেটিংস → "🪦 মুছে-যাওয়া entry"-তে তালিকা হয়ে থাকবে, হাতে আবার তুলতে হবে। আগে সবাইকে sync করিয়ে নাও (⏳ চিহ্ন না থাকা পর্যন্ত)। এগোবে?',
                     en: '⚠️ Restoring "{f}" replaces all current data with that snapshot. (A safety backup of the current state is taken first.)\n\n🔑 Everyone — you included — will be logged out and must sign in again.\n\n📵 And anything still unsent on someone\'s phone will NOT go up by itself: it is wiped, and left as a list on that phone under ⚙️ Settings → "🪦 Wiped entries" to be re-entered by hand. Get everybody synced first (until no ⏳ remains). Continue?' },
  ...
  // A295: closing a season
  err_already_closed: { bn: 'এই বছর আগেই বন্ধ করা হয়েছে', en: 'This year is already closed' },
  err_not_closed: { bn: 'এই বছর তো বন্ধই নেই', en: 'This year is not closed' },
  err_year_closed: { bn: 'বছর বন্ধ — নতুন entry নেওয়া যাবে না, admin আবার খুললে যাবে', en: 'The year is closed — new entries wait until an admin reopens it' },
  // A295: the 🏁 close-the-year screen
  closeyear_btn: { bn: '🏁 বছর শেষ করো', en: '🏁 Close the year' },
  closeyear_title: { bn: '🏁 বছর শেষ করো', en: '🏁 Close the year' },
  closeyear_hint: { bn: 'সব ঠিক থাকলে এই বছরের হিসাব বন্ধ করো। বন্ধ হলে নতুন entry নেওয়া যাবে না, কিন্তু সব পড়া ও রিপোর্ট খোলা থাকবে। পরে দরকার হলে আবার খোলা যায়।',
                   en: 'Close this year once everything checks out. Closed, no new entries are taken, but all reading and reports stay open. You can reopen it later if needed.' },
  cy_q1: { bn: 'সব ফোন sync হয়েছে (⏳ খালি)', en: 'Every phone has synced (⏳ empty)' },
  cy_q1_sub: { bn: 'সার্ভার এটা দেখতে পায় না — প্রত্যেকের ফোনে নিজে মিলিয়ে নাও', en: 'The server cannot see this — confirm on each phone' },
  cy_q2: { bn: 'কোনো জমা confirm বাকি নেই', en: 'No handover awaiting confirmation' },
  cy_q3: { bn: '🩺 কোনো অসংগতি নেই — হিসাব মিলেছে', en: 'No anomalies — the books balance' },
  cy_ready: { bn: 'সব ঠিক — বন্ধ করা যায়', en: 'All clear — ready to close' },
  cy_blocked: { bn: 'উপরের লাল জিনিসগুলো আগে ঠিক করো', en: 'Fix the red items above first' },
  cy_confirm: { bn: '🏁 এই বছরের হিসাব বন্ধ করবেন?\n\nবন্ধ হলে নতুন কোনো entry নেওয়া যাবে না (পড়া ও রিপোর্ট খোলা থাকবে)। পরে আবার খোলা যায়।', en: 'Close this year? No new entries will be taken (reading and reports stay open). You can reopen later.' },
  cy_closed_banner: { bn: '🏁 এই বছর বন্ধ আছে — নতুন entry নেওয়া হচ্ছে না', en: '🏁 This year is closed — no new entries are being taken' },
  cy_close_done: { bn: '🏁 বছর বন্ধ হয়েছে', en: 'The year is closed' },
  cy_reopen_btn: { bn: '🔓 আবার খোলো', en: '🔓 Reopen the year' },
  cy_reopen_confirm: { bn: 'এই বছর আবার খুলবেন? আবার entry নেওয়া যাবে।', en: 'Reopen this year? Entries will be accepted again.' },
  cy_reopen_done: { bn: '🔓 বছর আবার খোলা হয়েছে', en: 'The year is reopened' },
  ...
  anom_bad_amount_t: { bn: 'টাকার ঘরটা সংখ্যা নয়', en: 'That amount is not a number' },
  anom_bad_amount: { bn: '{store}: ঘরে লেখা আছে "{raw}" — এটা সংখ্যা হিসেবে পড়া যায় না, তাই সব হিসাবে এটা ₹০ ধরা হচ্ছে। Sheet-এ ইংরেজি অঙ্কে (যেমন 2000) লিখে দিন, কমা বা ₹ ছাড়া।',
                   en: '{store}: the cell reads "{raw}", which cannot be read as a number, so every total is counting it as ₹0. Type it in the Sheet as plain digits (e.g. 2000) with no comma or ₹.' },
  ...
  es_donor: { bn: 'দাতা', en: 'donor' },
  es_daily: { bn: 'দৈনিক তোলা', en: 'daily round' },
  es_void: { bn: 'বাতিল', en: 'cancelled' },
  es_flagged: { bn: 'ভুল বলে জানিয়েছিলাম', en: 'flagged as wrong' },
