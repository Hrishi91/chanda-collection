...
const I18N = {
  ...
  q_handover_amount: { bn: 'কোনটা জমা দিচ্ছ? (একটা বা দুটোই বাছো)', en: 'Which are you handing over? (pick one or both)' },
  total: { bn: 'মোট', en: 'Total' },
  custom_amount: { bn: '✏️ অন্য পরিমাণ (টাইপ করব)', en: '✏️ Different amount (type it)' },
  cash: { bn: 'নগদ', en: 'Cash' },
  upi: { bn: 'UPI', en: 'UPI' },
