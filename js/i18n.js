...
const I18N = {
  ...
  adm_members: { bn: 'কমিটির সদস্য', en: 'Committee members' },
  adm_members_hint: { bn: 'সদস্য যোগ হয় 🤝 সদস্য এন্ট্রি দিয়ে; এখানে শুধু app-অ্যাকাউন্ট জোড়া লাগানো যায়। এই যোগসূত্র টাকার হিসাব বদলায় না — টাকা যে তুলেছে তারই থাকে।',
                      en: "Members are added through the 🤝 member entry; here you only link an app account. The link never changes any money — it stays with whoever collected it." },
  adm_member_bare: { bn: '(পদ / ফোন / email কিছু দেওয়া নেই)', en: '(no position / phone / email recorded)' },
  adm_no_members: { bn: 'এখনো কোনো সদস্য যোগ হয়নি', en: 'No members added yet' },
