...
const I18N = {
  ...
  home_no_perm_body: { bn: 'admin ঠিক করে দিলে তবেই এন্ট্রি করতে পারবে। ততক্ষণ 💬 বার্তায় লিখতে পারো।',
                       en: 'You can make entries once the admin sets it up. Until then you can write in 💬 Chat.' },
